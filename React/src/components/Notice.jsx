        ...
        <div className='training'>
          <div className='left'>
            ...
            <p>To all writers and premium users, this is to notify you that access to funds generated
                 from streaming, will be granted to you if and only if you are the rightful author & creator
                 of a content or presentation that was rendered on our channel, please contact our support team to confirm
